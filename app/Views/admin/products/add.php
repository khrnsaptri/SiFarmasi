                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama Produk" <?php if (isset($inputs['name'])) { echo "value='" . $inputs['name'] . "'"; } ?> required>
                                                </div>
                                                <div class="col-lg-4">
                                                    <label for="price">Harga <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="price" name="price" placeholder="Masukkan Harga" <?php if (isset($inputs['price'])) { echo "value='" . $inputs['price'] . "'"; } ?> required>
                                                </div>
                                                <div class="col-lg-4">
                                                    <label for="weight">Berat (gram) <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" id="weight" name="weight" placeholder="Berat Barang" <?php if (isset($inputs['weight'])) { echo "value='" . $inputs['weight'] . "'"; } ?>>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <select name="category_id" id="category_id" class="form-control">
                                                        ...
                                                        <?php foreach ($categories as $category) : ?>
                                                            <option value="<?= $category['id'] ?>" <?php if (isset($inputs['category_id']) && $inputs['category_id'] == $category['id']) { echo "selected"; } ?>><?= $category['name'] ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label for="stock">Stok <span class="text-danger">*</span></label>
                                                    <input type="number" class="form-control" id="stock" name="stock" placeholder="Jumlah Barang" <?php if (isset($inputs['stock'])) { echo "value='" . $inputs['stock'] . "'"; } ?> required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" name="description">
                                                <?php if (isset($inputs['description'])) { echo $inputs['description']; } ?>
                                            </textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="additional_information">Informasi Tambahan</label>
                                            <textarea id="additional_information" name="additional_information">
                                                <?php if (isset($inputs['additional_information'])) { echo $inputs['additional_information']; } ?>
                                            </textarea>
                                        </div>
                                        <div class="form-group">
